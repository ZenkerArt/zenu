...
# from ..rig_lib.bone_utils import 
...
def bone_clone(bone: bpy.types.EditBone, name: str = None, prefix: str = None,
    ...
    new_bone.bbone_x = bone.bbone_x
    new_bone.bbone_z = bone.bbone_z
    bone_copy_transforms(bone, new_bone)

    return new_bone

def clear_bone_collection(bone: bpy.types.Bone):
...
def bone_get_head(bone: bpy.types.PoseBone) -> Vector:
    ...
    return bone.matrix.translation
